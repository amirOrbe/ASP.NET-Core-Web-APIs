...
// ejemplo para obtener los datos del repositorio In memory que tiene solo una region en duro => builder.Services.AddScoped<IRegionRepository, InMemoryRepository>();
builder.Services.AddScoped<IRegionRepository, SQLRegionRepositorie>();
